...
registerOnClick('sphere_black', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'paint_black', undefined);
}, function(event) {});

registerOnClick('sphere_chrome', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'Material.001', undefined);
}, function(event) {});

registerOnClick('sphere_white', false, false, [0,1,2], false, function(event) {
    assignMat('metal_stand', 'paint_black.001', undefined);
}, function(event) {});

registerOnClick('slab1', false, false, [0,1,2], false, function(event) {
    replaceTexture('Woodmaterial_0', 'wood.jpg.001', 'wood_basecolor_1.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab2', false, false, [0,1,2], false, function(event) {
    replaceTexture('Woodmaterial_0', 'wood.jpg.001', 'wood_basecolor_2.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab3', false, false, [0,1,2], false, function(event) {
    replaceTexture('Woodmaterial_0', 'wood.jpg.001', 'wood_basecolor_3.jpg', false, function() {});
}, function(event) {});
